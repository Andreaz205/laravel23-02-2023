...
//    Route::post('/categories/{product}/bind-delete', [\App\Http\Controllers\Category\CategoryController::class, 'destroyBind']);
    ...
    Route::delete('/categories/{category}/delete', [\App\Http\Controllers\Category\CategoryController::class, 'destroy']);
    ...
    Route::get('/reviews/data', [\App\Http\Controllers\Review\ReviewController::class, 'data']);

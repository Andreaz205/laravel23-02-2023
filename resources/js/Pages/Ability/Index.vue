                                ...
                                <tr>
                                    <td>
                                        <div class="flex justify-center items-center">
                                            <CustomSwitch :is-checked="isChecked(role, section, 'list')"
                                                          @changeSwitch="onSwitchChange('list', section, role)"
                                                          :switch-id="`custom-switch-row-${section.id}-col-${role.id}-read`"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="flex justify-center items-center">
                                            <CustomSwitch :is-checked="isChecked(role, section, 'create')"
                                                          @changeSwitch="onSwitchChange('create', section, role)"
                                                          :switch-id="`custom-switch-row-${section.id}-col-${role.id}-add`"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="flex justify-center items-center">
                                            <CustomSwitch :is-checked="isChecked(role, section, 'edit')"
                                                          @changeSwitch="onSwitchChange('edit', section, role)"
                                                          :switch-id="`custom-switch-row-${section.id}-col-${role.id}-edit`"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="flex justify-center items-center">
                                            <CustomSwitch :is-checked="isChecked(role, section, 'delete')"
                                                          @changeSwitch="onSwitchChange('delete', section, role)"
                                                          :switch-id="`custom-switch-row-${section.id}-col-${role.id}-delete`"/>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>

    ...
    <AuthenticatedLayout>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="flex justify-between my-3 relative">
                            <div class="flex justify-between items-center gap-x-2">
                                <h3 class="text-lg absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2">Клиенты</h3>
                                ...
                                <Link href="/admin/transactions">
                                    <button class="btn btn-default">Транзакции</button>
                                </Link>

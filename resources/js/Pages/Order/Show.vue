    ...
    <AuthenticatedLayout>
        <div v-if="order">
            ...
            <div class="flex justify-between items-center">
                <a href="/admin/orders">
                    <div class="d-flex justify-start mx-2 flex-nowrap items-center cursor-pointer hover:text-blue-500">
                        <div>
                ...
                <div>Заказ <span class="text-2xl text-red-500">{{ order.id }}</span> <span class="text-sm ">от</span> <span
                    class="text-2xl text-gray-600">{{ formatDate(order.created_at) }}</span></div>
            </div>
            ...
            <div>
                <table class="variants-table">
                    ...
                    <tr v-for="variant in variants">
                        ...
                        <td>
                            <div class="flex justify-center">
                                <a :href="'/admin/products/' + variant.product.id">
                                    <img :src="variant.images[0]?.image_url || '/storage/images/no-image.jpg'">
                                </a>
                            </div>
                        </td>
                        <td>
